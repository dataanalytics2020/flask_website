...
##### **過去データサンプルURL**
https://ana-slo.com/2024-05-26-%e3%82%a2%e3%82%a4%e3%83%a9%e3%83%b3%e3%83%89%e7%a7%8b%e8%91%89%e5%8e%9f%e5%ba%97-data/
...
このプロダクトは明日のお勧め店舗やデータの難しい分析を、誰でも、いつでも、より簡単に見れるようにという想いから生まれました。
簡単に分析できるサイトを見て分析する面白さを知ってほしいという側面もあります。
...
![image](https://github.com/dataanalytics2020/flask_website/assets/117744645/b39eeb8f-7b69-4b8b-bfbc-404434dce21a)

知人に使ってもらう事はほとんどしておらず、主にサーチコンソールとグーグルアナリティクスを使って
需要のある人気ページやアクセス数を分析し、機能の改善・追加・修正などをGithub Issueで管理しています。
![image](https://github.com/dataanalytics2020/flask_website/assets/117744645/49722485-4aa4-42b1-a174-675017b50723)


### プロダクトの現状と今後について
**おかげ様で現在では一日のDAUが3~5000人、月間PVが16万前後にまで見ていただけるサイトになりました。**
Twitterなどではまだプロモーションをあえて行っておらず、Nextjs,DRFでリプレイスする予定でもっとUI,UXの改善を行った後に
X上での自動ツイートプロモーションを行っていきたいと考えています。
#### 一年前に始めたサービス開始から今までの累計（約一年分）のデータ
![image](https://github.com/dataanalytics2020/flask_website/assets/117744645/891f2720-6ae2-4082-893b-c5c26945b265)
#### 24/04/25~24/05/25 （直近一か月分）のデータ
...
| 都道府県別日別記事機能➀(サムネイル) |　都道府県別日別記事機能➁(画像) |
| ---- | ---- |
...
| バックエンド           | Python3.9 ,Flask, WordPress REST API                         |
...
## システム構成図
![slomap_architecture](https://github.com/dataanalytics2020/flask_website/assets/117744645/44da8fda-da24-4d1a-ae62-9bd40e12b166)
